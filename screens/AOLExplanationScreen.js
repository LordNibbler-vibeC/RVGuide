/* Remote Viewing Guide - AOLExplanationScreen.js - v0.1.1 */
/*
 * CHANGELOG:
 * v0.1.2 (YYYY-MM-DD):
...
const AOLExplanationScreen = ({ navigation }) => {
  return (
    // --- KEINE SafeAreaView mehr ---
    <View style={globalStyles.placeholderContainer}>
      ...
      <Text style={globalStyles.placeholderText}>AOL Erklärung</Text>
...
export default AOLExplanationScreen;