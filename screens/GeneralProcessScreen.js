/* Remote Viewing Guide - GeneralProcessScreen.js - v0.1.1 */
/*
 * CHANGELOG:
 * v0.1.2 (YYYY-MM-DD):
...
const GeneralProcessScreen = ({ navigation }) => {
  return (
    // --- KEINE SafeAreaView mehr ---
    <View style={globalStyles.placeholderContainer}>
      ...
      <Text style={globalStyles.placeholderText}>Allgemeiner Prozess</Text>
...
export default GeneralProcessScreen;